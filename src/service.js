...
export const createCamera = async (camera) => {
  try {
    const response = await axios.post(api_host + "/api/device/creatCamera", camera);
...
export const updateCamera = async (camera) => {
  try {
    const response = await axios.post(api_host + `/api/device/updateCamera?camera_id=${camera.Camera_id}`, camera);
    return handleResponse(response, 200);
  } catch (error) {
    handleError(error);
  }
...
export const deleteCamera = async (camera_id) => {
  try {
    const response = await axios.post(api_host + `/api/device/deleteCamera?camera_id=${camera_id}`);
...
export const deleteArea = async (area_id) => {
  try {
    const response = await axios.post(api_host + `/api/device/deleteArea?area_id=${area_id}`);
    return handleResponse(response, 204);
  } catch (error) {
    handleError(error);
  }
...
export const updateArea = async (area) => {
  try {
    const response = await axios.post(api_host + `/api/device/updateArea?area_id=${area.id}`, area);
    return handleResponse(response, 200);
  } catch (error) {
    handleError(error);
  }
...
export const fetchEvents = async () => {
  try {
    const response = await axios.post(api_host + "/api/device/events");
    return handleResponse(response, 200);
  } catch (error) {
    handleError(error);
  }
